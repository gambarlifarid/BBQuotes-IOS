...
//  BBQuotes
//
//  Created by Farid Gambarli on 25.07.25.
//
...
struct FetchService {
    ...
    func fetchQuote(from show: String) async throws -> Quote {
        ...
        // Decode data
        let quote = try JSONDecoder().decode(Quote.self, from: data) // .self is for turning type into property
    ...
    func fetchDeath(for character: String) async throws -> Death? {
        ...
        } // forEach in swiftUI and for in Swift
